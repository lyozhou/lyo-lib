...
APP_KEY = '2966371598' # app key
APP_SECRET = 'ede41ea4f05bb735e23a1f5ca9ae214e' # app secret
CALLBACK_URL = 'http://open.weibo.com/apps/2966371598/privilege/oauth' #callback url
...
saved_location = set()
saved_latLon = set()
saved_latLon.add(('31.23477','121.4748'))
...
row = cur.execute('select lat,lon from weibo_location where checkin_num>500 LIMIT 0,666')
results  = cur.fetchmany(row)
for r in results:
    saved_latLon.add(r)
